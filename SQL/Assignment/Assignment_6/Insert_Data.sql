...
VALUES                  ("levanquy@gmail.com"		,"lvquy"		,"Le Van Quy"		,8				,1				,"2019/11/02"),
						("nguyenvanngoc@gmail.com"	,"nvngoc"		,"Nguyen Van Ngoc"	,3				,1				,"2018/11/04"),
						("ledinhanh@gmail.com"		,"ldanh"		,"Nguyen Dinh Anh"	,4				,4				,"2012/1/25"),
						("hoangkhanhlinh@gmail.com"	,"hoangkl"		,"Hoang Khanh Linh"	,3				,4				,"2011/12/25"),
						("ledinhvu@gmail.com"		,"ldvu"			,"Le Dinh Vu"		,6				,2				,"1994/10/10"),
						("duongquanglong@gmail.com"	,"dglong"		,"Duong QUang Long"	,1				,2				,"1993/1/28"),
						...
						("lethanhdat@gmail.com"		,"ltdat"		,"Le Thanh Dat"		,1				,8				,"1991/11/21"),
...
VALUES                      	("Câu hỏi về Lap Trinh JAVA"	,2				,1			,1			,"2020/01/02"),
								...
								("Câu hỏi về Lap Trinh LABVIEW"	,1				,2			,6			,"2020/04/02"),
								("Câu hỏi về Lap Trinh PASSCAL"	,1				,1			,7			,"2020/04/02"),
